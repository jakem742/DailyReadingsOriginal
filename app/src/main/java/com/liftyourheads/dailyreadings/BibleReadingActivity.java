...
import static com.liftyourheads.dailyreadings.BibleMainActivity.readings;
...
public class BibleReadingActivity extends AppCompatActivity {
    ...
    public void updateHeader(int reading) {
        ...
        if (!paragraphs && (readings[reading].getNumChapters() > 1 )) {
            ...
            String readingBookName = readings[reading].getBookName();
    ...
    public void returnToMain(View view) {
        ...
        Intent myIntent = new Intent(this, BibleMainActivity.class);
    ...
    class Player extends AsyncTask<String, Void, Boolean> {
        ...
        public Player() {
            progress = new ProgressDialog(BibleReadingActivity.this);
        }
    ...
    public static class MyPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            switch (position) {
                case 0:
                    return bibleContentFragment.newInstance(1);
                case 1:
                    return bibleContentFragment.newInstance(2);
                case 2:
                    return bibleContentFragment.newInstance(3);
                default:
                    return null;
            }
        }
    ...
    private MediaBrowserCompat.ConnectionCallback mMediaBrowserCompatConnectionCallback = new MediaBrowserCompat.ConnectionCallback() {
        ...
        public void onConnected() {
            ...
            try {
                ...
                audio.putString("Book",readings[curReadingNum].getBookName());
                ...
                mMediaControllerCompat = new MediaControllerCompat(BibleReadingActivity.this, mMediaBrowserCompat.getSessionToken());
                mMediaControllerCompat.registerCallback(mMediaControllerCompatCallback);
                MediaControllerCompat.setMediaController(BibleReadingActivity.this, mMediaControllerCompat);
                MediaControllerCompat.getMediaController(BibleReadingActivity.this).getTransportControls().playFromMediaId(readings[curReadingNum].getAudioURL(0), audio);
    ...
    protected void onDestroy() {
        super.onDestroy();
        if( MediaControllerCompat.getMediaController(BibleReadingActivity.this).getPlaybackState().getState() == PlaybackStateCompat.STATE_PLAYING ) {
            MediaControllerCompat.getMediaController(BibleReadingActivity.this).getTransportControls().pause();
        }
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if( mCurrentState == STATE_PAUSED ) {
                    MediaControllerCompat.getMediaController(BibleReadingActivity.this).getTransportControls().play();
                    mCurrentState = STATE_PLAYING;
                } else {
                    if( MediaControllerCompat.getMediaController(BibleReadingActivity.this).getPlaybackState().getState() == PlaybackStateCompat.STATE_PLAYING ) {
                        MediaControllerCompat.getMediaController(BibleReadingActivity.this).getTransportControls().pause();
