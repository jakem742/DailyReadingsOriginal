...
public class BibleMainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        commentsFragment.getComments(selectedDay,selectedMonth);
        */

        if (!commentsFragment.commentsDownloaded) {
    ...
    public void goToBibleReadings(View view) {
        ...
        Intent myIntent = new Intent(this, BibleReadingActivity.class);
    ...
    public void populateList() {
        ...
        for (int i = -15; i < 15; i++) {
            ...
            if ((day == curDay) && month.equals(curMonth)) {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                switch (text) {
                    ...
                    case "Tomorrow":
                        ...
                        selectedMonth = monthStringTemplate.format(gc.getTime());
                    ...
                    case "Yesterday":
                        ...
                        selectedMonth = monthStringTemplate.format(calendar.getTime());
                ...
                Log.i("Date Selected", selectedDay.toString() + " " + selectedMonth);

                if (selectedMonth.equals("February") && (selectedDay == 29)) {
    ...
    public class Reading {
        ...
        private void setFullName() {
            ...
            if (!this.singleChapterBook && !this.multipleBooks) { //Include chapter number if book contains more than one!
                ...
                Log.i("Book Name 1", bookName[0]);
                Log.i("Book Name 2", bookName[1]);
        ...
        public void updateVerses() {
            ...
            Log.i("Getting Verses", this.bookName + " " + Arrays.asList(this.chapters));
            if (!this.multipleBooks) {

                verses = getVerses(this.bookName[0], this.chapters, this.isChapterPartial(), this.versesPartialChapter);

            } else {

                //Todo: Fetch verses for multiple books
                verses = getVerses(this.bookName[0], this.chapters, this.isChapterPartial(), this.versesPartialChapter);
            ...
            for (Integer i = 0; i < verses.length; i++) {

                chapterStartCounters[i] = verses[i].length;
                ...
                if (this.chapters.length > 1) {
                    ...
                    verseParagraphs.append("<big><span style=\"color:#9ccc65\"><b>" + this.bookName[0] + " " + this.chapters[i] + "</b></span></big><br/>");
                }
                ...
                try {
                    ...
                    for (int j = 0; j < verses[i].length; j++) {
                        ...
                        verseContent = verses[i][j].replaceAll("([A-Z][\\w'-]*(?:\\s+[A-Z][\\w'-]*|\\s+(?:a|an|for|the|and|but|or|on|in|with))+(?: <br\\/>)+(?:\\s*))", "").replaceAll("<[^>]*>", "").trim();//.replaceAll("(\\{[a-zA-Z0-9.,: ;]+\\})+$", "").replaceAll("&#x27;", "'").replaceAll("\\{(.*?)\\}", "$1");
                        ...
                        //For paragraph view
                        verseParagraphs.append("<span style=\"color:#9ccc65\"><small><sup><b><i>").append(curVerse.toString()).append("</i></b></sup></small></span>&nbsp;").append(verses[i][j].replaceAll("<pb/>", ""));//
    ...
    public void setReadings(Integer day, String month){
        ...
        if (month.equals("February") && day == 29 ) {
            ...
            dateTextView.setText(Integer.toString(day) + " " + month);
            ...
            Log.i("Date", Integer.toString(day) + " " + month);
    ...
    public String[][] getDailyReadings(Integer day, String month) {
    ...
    public String[][] getVerses(String bookName, Integer[] chapters, Boolean isPartialChapter, Integer[] versesPartial) {
        ...
        String[][] verses = new String[chapters.length][];

        //Get the current book number for use in verses db
        Cursor book = bibleDB.rawQuery("SELECT * FROM books WHERE long_name = \'" + bookName + "\'", null);
        ...
        try {
            ...
            bookNumber = book.getString(book.getColumnIndex("book_number"));
            book.close();

        } catch (Exception e) {

            e.printStackTrace();
            Log.i("Getting Book Number", "Invalid book name: " + bookName);
        }
        ...
        try {
            ...
            for (int i = 0; i < chapters.length; i++) {
                ...
                verses[i] = new String[reading.getCount()];
                ...
                do {
                    ...
                    verses[i][j] = reading.getString(contentIndex).replaceAll("’", "'").replaceAll("<f>.*?</f>", "");//.replaceAll("<pb/>", "")
                    j++;
    ...
    public static class MyPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            switch (position) {
                case 0:
                    return commentsFragment.newInstance(1);
                case 1:
                    return commentsFragment.newInstance(2);
                case 2:
                    return commentsFragment.newInstance(3);
                default:
                    return null;
            }
        }
    ...
    public void getComments(Integer day, String month) {
        ...
        */
        ...
        if (!commentsDownloaded && !isRefreshing) {
            ...
            for (int i = 0; i < 12; i++) {
                ...
                if (month.equals(BibleMainActivity.MONTHS[i])) {
    ...
    public class DownloadComments extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String commentsHTML) {
            ...
            try {
                ...
                allComments = new String[readingChunks.length][];

                notesSize = new int[readingChunks.length];
                maxNotes = 0;

                /// DIVIDE READINGS INTO INDIVIDUAL NOTES ///

                for (int i = 0; i < readingChunks.length; i++) {

                    allComments[i] = readingChunks[i].split("<div class=\"note\">");
    ...
    public void separateNoteFromPoster() {

        //Todo: Make more efficient array size
        commentPost = new String[readingChunks.length][maxNotes][];
        ...
        if (getResources().getConfiguration().orientation == Configuration.ORIENTATION_PORTRAIT) {
            ...
            if (curDay != null && curMonth != null) {
                ...
                if (selectedMonth != null && selectedDay != null) {
                    ...
                    dateTextView.setText(selectedDay.toString() + " " + MONTHS[(Integer.parseInt(selectedMonth)-1)]);
            ...
            if (curDay != null && curMonth != null) {
                ...
                if (selectedMonth != null && selectedDay != null) {
                    ...
                    dateTextView.setText(selectedDay.toString() + " " + MONTHS[(Integer.parseInt(selectedMonth)-1)].substring(0,3));

                } else {

                    dateTextView.setText(curDay.toString() + " " + curMonth.substring(0,3));
    ...
    public void onNewIntent(Intent newIntent) {
        ...
        //Check that intent is from BibleReadingActivity
    ...
    public void onResume() {
        ...
        //Force theme reload if theme has been changed by SettingsActivity
        if (forceRestart) {
