...
public class DataBaseHelper extends SQLiteOpenHelper {
    ...
    public final static String DATABASE_PATH = "/data/data/com.liftyourheads.dailyreadings/databases/";
    ...
    public void createDatabase() throws IOException
    {
        ...
        if(dbExist)
        {
            Log.v("DB Exists", DATABASE_PATH + dbName + " exists");
    ...
    private void copyDataBase()
    {
        ...
        try {
            InputStream mInput = myContext.getAssets().open("DB/" + dbName);
