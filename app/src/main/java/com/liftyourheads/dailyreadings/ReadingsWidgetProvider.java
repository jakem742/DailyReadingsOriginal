...
public class ReadingsWidgetProvider extends AppWidgetProvider {
    ...
    public void onUpdate(Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            //TODO: Make readings a public class accessible from anywhere!!
            //remoteViews.setTextViewText(R.id.reading1TextView, activity_date.readings[0].getFullName());
            //remoteViews.setTextViewText(R.id.reading2TextView, activity_date.readings[1].getFullName());
            //remoteViews.setTextViewText(R.id.reading3TextView, activity_date.readings[2].getFullName());
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (intent.getAction().equals(ACTION_SCHEDULED_UPDATE)) {
            ...
            int[] ids = manager.getAppWidgetIds(new ComponentName(context, ReadingsWidgetProvider.class));
    ...
    private static void _scheduleNextUpdate(Context context) {
        ...
        Intent intent = new Intent(context, ReadingsWidgetProvider.class);
